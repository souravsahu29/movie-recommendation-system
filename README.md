...
2. Install all the libraries mentioned in the [requirements.txt](https://github.com/sourav-sahu-23/Movie-Recommendation-System/master/requirements.txt) file with the command `pip install -r requirements.txt`
